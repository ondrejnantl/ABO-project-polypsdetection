...
pathCVC_Orig = 'C:\Users\Lenovo\Desktop\ABO-project-polypsdetection-main\ABO-project-polypsdetection-main\data\polypy\CVC-ClinicDB\CVC-ClinicDB\Original\';
pathCVC_Mask = 'C:\Users\Lenovo\Desktop\ABO-project-polypsdetection-main\ABO-project-polypsdetection-main\data\polypy\CVC-ClinicDB\CVC-ClinicDB\Ground Truth\';
for idx = 45
...
[x,y] = getpts(); %select coordinates with mouse and enter 
x=round(x);
y=round(y);

%% region growing
seedRow = x; % je nutne vymyslet jak zjistit pozici seminka
seedCol = y;
figure;
for i = 1:o
